 ...
 */
class CRM_Scheduledccrecipients_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Scheduledccrecipients_Upgrader(
        'au.com.agileware.scheduledccrecipients',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Scheduledccrecipients_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
